<script>
    ...
    var routes = {
        ...
        update: id => `{{ route('systemInformation.update', ':id') }}`.replace(':id', id),
...
<script>
    var exportInvoicesUrl = "{{ route('downloadSystemInformationExcel') }}";
    var exportInvoicesUrlPdf = "{{ route('downloadSystemInformationPdf') }}";

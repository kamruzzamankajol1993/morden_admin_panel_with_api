...
@section('title')
Edit Blog Post | {{ $ins_name ?? 'Your App Name' }}
@endsection
        ...
        <div class="card-body">
            <form action="{{ route('blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="summernote" name="des" rows="10">{{ $blog->des }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="image" class="form-label">Feature Image (Choose a new one to replace)</label>
                    <input class="form-control" type="file" id="image" name="image">
                    <div class="image-preview-container">
                        <p>Image Preview:</p>
                        <img id="image-preview" src="{{ asset($blog->image) }}" alt="Image Preview">
                    </div>
                </div>

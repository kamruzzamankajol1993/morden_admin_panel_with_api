...
Create New Service | {{ $ins_name ?? 'Your App Name' }}
...
<div class="dashboard-body container py-4">
    ...
    <div class="card shadow-lg rounded-3">
        ...
        <div class="card-header">
            Create New Service
            <p class="text-muted mb-0 mt-2">Fill in the details to add a new service.</p>
        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('des') is-invalid @enderror" id="des" name="des" rows="5" required>{{ old('des') }}</textarea>
                                @error('des')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
...
<script>
    $(function() {
        ...
        // Form submission (no date validation for service model)

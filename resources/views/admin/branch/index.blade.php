...
Branch/Agent Organization | {{ $ins_name }}
...
<li><span class="text-main-600 fw-normal text-15">Branch/Agent Organization</span></li>
</ul>
</div>
<!-- Breadcrumb End -->
    ...
    <div class="card overflow-hidden">
        ...
        <table class="table table-bordered table-hover">
            <thead class="table-light">
                <tr>
                    <th>Sl</th>
                    <th class="sortable" data-column="name">Branch/Agent Organization Name</th>
                    <th >Action</th>
                </tr>
            </thead>

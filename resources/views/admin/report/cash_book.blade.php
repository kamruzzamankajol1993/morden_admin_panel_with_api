...
<main class="main-content">
    <div class="container-fluid">
        <h2 class="mb-4">Cash Book Report</h2>
...
$(document).ready(function() {
    ...
    $.ajax({
        url: "{{ route('reports.cash_book.dependencies') }}",
        type: 'GET',
    ...
    generateBtn.on('click', function() {
        ...
        $.ajax({
            url: "{{ route('reports.cash_book.generate') }}",
            type: 'GET',
            data: {
    ...
    function renderReport(data, accountName) {
        ...
        data.transactions.forEach(entry => {
         ...
         const printUrl = new URL("{{ route('reports.cash_book.print') }}");

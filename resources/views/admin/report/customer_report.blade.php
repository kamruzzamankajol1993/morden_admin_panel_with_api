    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                <h5 class="mb-0">Customer Wise Sales Report</h5>
                <div class="d-flex align-items-center flex-wrap">
                    ...
                    <input type="text" id="search-input" class="form-control form-control-sm" placeholder="Search customer..." style="width: 200px;">
                </div>
            </div>
            <div class="card-body">
                @include('admin.report._partial._customer_table')
            </div>
        </div>
    </div>
</main>
...
@section('script')
@include('admin.report._partial._customer_script')
@endsection

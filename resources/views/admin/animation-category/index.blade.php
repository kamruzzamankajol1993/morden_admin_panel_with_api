...
<main class="main-content">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
            <h2 class="mb-0">Animation Category List</h2>
...
@include('admin.animation-category._partial.addModal')
@include('admin.animation-category._partial.editModal')
@endsection

@section('script')
@include('admin.animation-category._partial.script')
@endsection

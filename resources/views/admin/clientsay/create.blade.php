...
@section('title')
Add New ClientSay | {{ $ins_name ?? 'Your App Name' }}
@endsection
        ...
        <div class="card-body">
            <form action="{{ route('clientSay.store') }}" method="POST">
                ...
                <div class="d-grid gap-2 mt-4">
                    <button type="submit" class="btn btn-save-clientsay d-inline-flex align-items-center justify-content-center">
                        <i class="fas fa-plus-circle me-2"></i> Add ClientSay
                    </button>
                </div>
            </form>
        </div>

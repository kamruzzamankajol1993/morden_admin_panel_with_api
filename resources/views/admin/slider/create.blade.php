...
Create New Banner | {{ $ins_name ?? 'Your App Name' }}
...
<div class="dashboard-body container py-4">
    ...
    <div class="card shadow-lg rounded-3">
        ...
        <div class="card-header">
            Create New Banner
            <p class="text-muted mb-0 mt-2">Upload an image for the Banner and set its status.</p>
        </div>

        <div class="card-body">
            <form action="{{ route('banner.store') }}" method="POST" enctype="multipart/form-data" id="sliderForm">
                @csrf
                ...
                <div class="mt-5 text-center">
                    <button type="submit" class="btn btn-action-primary me-3 d-inline-flex align-items-center">
                        <i class="fas fa-plus-circle me-2"></i> Create Banner
                    </button>

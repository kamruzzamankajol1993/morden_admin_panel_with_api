                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="subcategory_id" id="subcategoryId" class="form-select"></select>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Sub-Subcategory</label>
                                <select name="sub_subcategory_id" id="subSubcategoryId" class="form-select"></select>
                            </div>
                            <div class="mb-3">
            ...
            <div class="variant-section border rounded p-3 mb-3">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="variants[${variantIndex}][color_id]" class="form-select variant-color-select">${colorOptions}</select>
                    </div>
                    <div class="col-md-4 mb-3">

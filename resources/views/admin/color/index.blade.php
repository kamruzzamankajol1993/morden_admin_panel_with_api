        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
            ...
            <div class="d-flex align-items-center">
                ...
                <a type="button" data-bs-toggle="modal" data-bs-target="#addModal" class="btn text-white" style="background-color: var(--primary-color); white-space: nowrap;">
                    <i data-feather="plus" class="me-1" style="width:18px; height:18px;"></i> Add New Color
                </a>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered">
                        <thead>
                            <tr>
                                <th>Sl</th>
                                <th class="sortable" data-column="name">Color Name</th>
...
@include('admin.color._partial.addModal')
@include('admin.color._partial.editModal')
@endsection

@section('script')
@include('admin.color._partial.script')
@endsection

...
<div class="top-navbar flex-between gap-16">
    ...
    <div class="flex-align gap-16">
        ...
        <!-- Toggle Button End -->
        <span style="font-weight:bold;font-size:20px;color:white;" >{{$ins_name}}</span>  <span style="font-weight:bold;font-size:20px;color:white;">{{  date('d F Y') }}</span>
    ...
    <div class="flex-align gap-16">
        <div class="flex-align gap-8">
            <!-- Notification Start -->
            <div class="dropdown">
                <button class="dropdown-btn  text-gray-500 w-40 h-40 bg-main-50 hover-bg-main-100 transition-2 rounded-circle text-xl flex-center" type="button" onclick="location.href='{{url('/clear')}}'">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-24 max-h-270 overflow-y-auto scroll-sm">
                                <div class="d-flex align-items-start gap-12">
                                    <img src="{{asset('/')}}public/admin/assets/images/thumbs/notification-img1.png" alt="" class="w-48 h-48 rounded-circle object-fit-cover">
                                    <div class="border-bottom border-gray-100 mb-24 pb-24">
                                        ...
                                        <div class="flex-align gap-6 mt-8">
                                            <img src="{{asset('/')}}public/admin/assets/images/icons/google-drive.png" alt="">
                                            <div class="flex-align gap-4">
                                ...
                                <div class="d-flex align-items-start gap-12">
                                    <img src="{{asset('/')}}public/admin/assets/images/thumbs/notification-img2.png" alt="" class="w-48 h-48 rounded-circle object-fit-cover">
                                    <div class="">
                            ...
                            <div class="max-h-270 overflow-y-auto scroll-sm pe-8">
                                <div class="form-check form-radio d-flex align-items-center justify-content-between ps-0 mb-16">
                                  <label class="ps-0 form-check-label line-height-1 fw-medium text-secondary-light" for="arabic"> 
                                    <span class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-8"> 
                                      <img src="{{asset('/')}}public/admin/assets/images/thumbs/flag1.png" alt="" class="w-32-px h-32-px border borde border-gray-100 rounded-circle flex-shrink-0">
                                ...
                                <div class="form-check form-radio d-flex align-items-center justify-content-between ps-0 mb-16">
                                  <label class="ps-0 form-check-label line-height-1 fw-medium text-secondary-light" for="germany"> 
                                    <span class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-8"> 
                                      <img src="{{asset('/')}}public/admin/assets/images/thumbs/flag2.png" alt="" class="w-32-px h-32-px border borde border-gray-100 rounded-circle flex-shrink-0">
                                ...
                                <div class="form-check form-radio d-flex align-items-center justify-content-between ps-0 mb-16">
                                  <label class="ps-0 form-check-label line-height-1 fw-medium text-secondary-light" for="english"> 
                                    <span class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-8"> 
                                      <img src="{{asset('/')}}public/admin/assets/images/thumbs/flag3.png" alt="" class="w-32-px h-32-px border borde border-gray-100 rounded-circle flex-shrink-0">
                                ...
                                <div class="form-check form-radio d-flex align-items-center justify-content-between ps-0">
                                  <label class="ps-0 form-check-label line-height-1 fw-medium text-secondary-light" for="spanish"> 
                                    <span class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-8"> 
                                      <img src="{{asset('/')}}public/admin/assets/images/thumbs/flag4.png" alt="" class="w-32-px h-32-px border borde border-gray-100 rounded-circle flex-shrink-0">
        ...
        <div class="dropdown">
            <button class="users arrow-down-icon border border-gray-200 rounded-pill p-4 d-inline-block pe-40 position-relative" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                <span class="position-relative">
                    ...
                    <img src="{{asset('/')}}public/No_Image_Available.jpg" alt="Image" class="h-32 w-32 rounded-circle">
                    @else
                    <img src="{{asset('/')}}{{ Auth::user()->image }}" alt="Image" class="h-32 w-32 rounded-circle">
                    @endif
                ...
                <div class="card border border-gray-100 rounded-12 box-shadow-custom">
                    <div class="card-body">
                        <div class="flex-align gap-8 mb-20 pb-20 border-bottom border-gray-100">
                            @if(empty(Auth::user()->image))
                            <img src="{{asset('/')}}public/No_Image_Available.jpg" alt="" class="w-54 h-54 rounded-circle">
                            @else
                            <img src="{{asset('/')}}{{ Auth::user()->image }}" alt="" class="w-54 h-54 rounded-circle">
                            @endif
                            <div class="">
                        ...
                        <ul class="max-h-270 overflow-y-auto scroll-sm pe-4">
                            ...
                            <li class="mb-4">
                                <a href="{{ route('profileView') }}" class="py-12 text-15 px-20 hover-bg-gray-50 text-gray-300 rounded-8 flex-align gap-8 fw-medium text-15">
                            ...
                            <li class="mb-4">
                                <a href="{{ route('profileSetting') }}" class="py-12 text-15 px-20 hover-bg-gray-50 text-gray-300 rounded-8 flex-align gap-8 fw-medium text-15">
        ...
        onclick="event.preventDefault();
                      document.getElementById('admin-logout-form').submit();" class="py-12 text-15 px-20 hover-bg-danger-50 text-gray-300 hover-text-danger-600 rounded-8 flex-align gap-8 fw-medium text-15">

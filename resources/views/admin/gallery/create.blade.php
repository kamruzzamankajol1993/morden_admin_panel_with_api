...
Create New Gallery | {{ $ins_name ?? 'Your App Name' }}
...
<div class="dashboard-body container py-4">
    ...
    <div class="mb-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{route('gallery.index')}}">Gallery Management</a></li>
    ...
    <div class="card shadow-lg rounded-3">
        ...
        <div class="card-header">
            Create New Gallery
            <p class="text-muted mb-0 mt-2">Upload an image for the gallery and set its status.</p>
        </div>

        <div class="card-body">
            <form action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data" id="sliderForm">
                @csrf

                <div class="row g-4 justify-content-center">
                    {{-- Image & Status Section --}}
                    <div class="col-12 col-md-8 col-lg-6">
                        <h5 class="section-header text-center">Gallery Image & Status</h5>
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <div class="image-preview-container">
                                    <img id="imagePreview" src="https://placehold.co/150x150/E0E0E0/505050?text=No+Image" alt="Image Preview">
                                </div>
                            </div>
                            <div class="col-12">
    ...
    $(function() {
        ...
        $('#image').on('change', function() {
            ...
            if (file) {
                ...
                imagePreview.attr('src', 'https://placehold.co/150x150/E0E0E0/505050?text=No+Image'); // Default placeholder
            }
        });
    });
</script>

...
Edit Gallery | {{ $ins_name ?? 'Your App Name' }}
...
<div class="dashboard-body container py-4">
    ...
    <div class="card shadow-lg rounded-3">
        ...
        <div class="card-header">
            Edit Gallery
            <p class="text-muted mb-0 mt-2">Update the Gallery image and status.</p>
        </div>

        <div class="card-body">
            <form action="{{ route('gallery.update', $gallery->id) }}" method="POST" enctype="multipart/form-data" id="sliderForm">
                @csrf
                @method('PUT')
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <div class="image-preview-container">
                                    <img id="imagePreview" src="{{ $gallery->image ? asset($gallery->image) : 'https://placehold.co/150x150/E0E0E0/505050?text=No+Image' }}" alt="Image Preview">
                                </div>
                            </div>
                            <div class="col-12">

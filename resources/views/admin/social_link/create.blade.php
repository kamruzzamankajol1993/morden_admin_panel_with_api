...
@section('title')
Create Social Link | {{ $ins_name ?? 'Your App Name' }}
@endsection
    ...
    <div class="mb-4 d-flex justify-content-between align-items-center">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{route('socialLink.index')}}">Social Link Management</a></li>
        ...
        <div class="card-body ">
            <form action="{{ route('socialLink.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="title" name="title" required>
                                ...
                                @foreach ($socialMediaNames as $platform)
                                    <option value="{{ $platform }}" {{ old('title') == $platform ? 'selected' : '' }}>{{ $platform }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="link" name="link" placeholder="e.g., https://www.facebook.com/your-profile" value="{{ old('link') }}" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4 text-end">
                    ...
                    <a href="{{ route('socialLink.index') }}" class="btn btn-danger">Cancel</a>
                </div>
            </form>
        </div>
    </div>

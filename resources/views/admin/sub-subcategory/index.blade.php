...
@section('css')
<style>
    /* Paste the same custom select CSS here */
...
<main class="main-content">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
            <h2 class="mb-0">Sub-Subcategory List</h2>
...
@include('admin.sub-subcategory._partial.addModal')
@include('admin.sub-subcategory._partial.editModal')
@endsection

@section('script')
@include('admin.sub-subcategory._partial.script')
@endsection

...
@section('title')
Edit Review | {{ $ins_name ?? 'Your App Name' }}
@endsection
    ...
    <div class="mb-4 d-flex justify-content-between align-items-center">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{route('review.index')}}">Review Management</a></li>
                <li class="breadcrumb-item active" aria-current="page">Edit Review</li>
            </ol>
        </nav>
        <!-- Breadcrumb End -->

        <a href="{{ route('review.index') }}" class="btn btn-back-to-list d-inline-flex align-items-center">
        ...
        <div class="card-body">
            <form action="{{ route('review.update', $review->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('des') is-invalid @enderror" id="des" name="des" rows="4" required>{{ old('des', $review->des) }}</textarea>
                    @error('des')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="url" class="form-control @error('youtube_video_link') is-invalid @enderror" id="youtube_video_link" name="youtube_video_link" value="{{ old('youtube_video_link', $review->youtube_video_link) }}">
                ...
                <div class="d-grid gap-2 mt-4">
                    <button type="submit" class="btn btn-update-Review d-inline-flex align-items-center justify-content-center">
                        <i class="fas fa-sync-alt me-2"></i> Update Review
                    </button>
                </div>
            </form>
        </div>
